...
function loadContent(lang) {
    ...
    if (lang === 'es') {
        languageButton.innerHTML = '<img src="flag-es.png" alt="Español" class="flag-icon"> Español';
    } else {
        languageButton.innerHTML = '<img src="flag-en.png" alt="English" class="flag-icon"> English';
    }
}
